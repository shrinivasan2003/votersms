    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-brand-navy">Add SMS Template</h1>
            <p className="text-brand-textMuted mt-1">Create a new SMS template</p>
          </div>
          <button 
            onClick={handleBack} 
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-brand-navy">SMS Templates</h1>
          <p className="text-brand-textMuted mt-1">Manage SMS message templates</p>
        </div>
