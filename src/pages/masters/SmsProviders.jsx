        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-brand-navy">
              {editingRow ? 'Edit SMS Provider' : 'Add SMS Provider'}
            </h1>
            <p className="text-brand-textMuted mt-1">
              {editingRow ? 'Update existing service configuration' : 'Configure a new SMS gateway'}
            </p>
          </div>
          <button 
            onClick={handleBack} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div className="space-y-2">
                ...
                <input 
                  type="number"
                  name="priority"
                  defaultValue={editingRow?.priority || '1'} 
                  className="block w-full rounded-lg border border-brand-border px-4 py-3 outline-none focus:border-brand-blue focus:ring-1 focus:ring-brand-blue transition-all"
                />
                <p className="text-[11px] text-brand-textMuted">Higher priority providers are used first (default: 1)</p>
              </div>
            </div>
            ...
            <div className="pt-4 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    placeholder="e.g., ACxxxxxxxxxxxxxxxxxxxxxxxx"
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="block w-full rounded-lg border border-brand-border px-4 py-3 outline-none focus:border-brand-blue focus:ring-1 focus:ring-brand-blue transition-all"
                />
                <p className="text-[11px] text-brand-textMuted">Your Twilio phone number (E.164 format)</p>
              </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-brand-navy">SMS Providers</h1>
          <p className="text-brand-textMuted mt-1">Manage SMS service providers</p>
        </div>
