...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Platform admin should use the Admin Login link, not the customer form
      if (!userData?.customer_id && userData?.role?.toLowerCase() === 'admin') {
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center">
          ...
          <div className="space-y-6 mt-8 max-w-md">
            {[
              ...
              { Icon: Database, title: 'Scalable Infrastructure', desc: 'Built to handle enterprise-level workloads and millions of messages.' },
            ].map(({ Icon, title, desc }) => (
              <div key={title} className="flex items-start space-x-5 group">
        ...
        <div className="w-full max-w-[500px]">
          <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
            <div className="bg-[#001F3F] p-6 lg:p-8 text-white">
              ...
              <p className="text-gray-400 text-sm mt-1">Sign in to access your portal</p>
            </div>
