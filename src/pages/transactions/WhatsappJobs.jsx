    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-brand-navy">Create WhatsApp Job</h1>
            <p className="text-brand-textMuted mt-1">Create a new WhatsApp messaging job</p>
          </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-brand-navy">WhatsApp Jobs</h1>
          <p className="text-brand-textMuted mt-1">Manage WhatsApp messaging jobs</p>
        </div>
